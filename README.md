#### Вариант решения на массиве (слайсе) с len = RPC. Можно обрабатывать очередной запрос, если с момента выполнения 100-го запроса назад от текущего прошло более 1 сек.
